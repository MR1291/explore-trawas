            ...
            {filteredDestinations.map((dest) => (
              ...
              >
                ...
                <div className="relative h-48 overflow-hidden bg-slate-100 shrink-0">
                  ...
                  <div className="absolute bottom-4 left-4 bg-emerald-600 text-white text-xs font-semibold px-2.5 py-1 rounded-full capitalize">
                    {dest.category}
                  </div>
                </div>
                ...
                <div className="p-6 flex flex-col flex-grow justify-between space-y-4">
                  ...
                  <Link
                    ...
                    className="w-full inline-flex items-center justify-center px-4 py-2 border border-slate-200 hover:border-emerald-600 rounded-full shadow-sm text-xs font-semibold text-slate-700 hover:text-emerald-600 hover:bg-emerald-50/20 transition-all pt-2"
                  >
